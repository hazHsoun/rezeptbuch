...
import 'package:rezeptbuch/ui/home_page/recipeSection.dart/image_picker.dart';
                    ...
                    Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          if (image == null && !showImageOptions)
                            Positioned(
                              bottom: 80.0,
                              left: 100.0,
                              child: ElevatedButton(
                                onPressed: () async {
                                  final pickedImage = await CustomImagePicker()
                                      .uploadImage(context);
                                  if (pickedImage != null) {
                                    setState(() {
                                      image = File(pickedImage.path);
          ...
          onTap: (index) {
            if (_currentIndex == 0) {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        BuildSecondPage()), // Navigate to the next page
              );
            }
          },
...
@override
Widget build(BuildContext context) {
  return Center(child: Text('SecondPage'));
}
